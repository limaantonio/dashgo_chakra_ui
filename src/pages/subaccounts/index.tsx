import {
  ...
  export default function SubAccountList() {
    ...
    async function handleDelete(id: string) {
      ...
      const subAccountIndex = subAccounts.findIndex((b) => b.id === id);
      const subAccount = [...subAccounts];
          ...
          <Box flex="1">
            ...
            <Box flex="1" borderRadius={8} bg="gray.800" p="8">
                        ...
                        <Td>
                          <Menu>
                            ...
                            <MenuList textColor="black">
                              <Link href={`/subaccounts/edit?id=${subAccount?.id}`}>
                          ...
                          <AlertDelete
                            ...
                            handleRemove={() => handleDelete(subAccount.id)}
                          />
                        </Td>
                      </Tr>
                    ))
              ...
              <Tr>
                <Th>Total</Th>
                <Th></Th>
                <Th>{subAccounts.reduce((acc, item) => Number(acc) + Number(item.percentage), 0)}%</Th>
                <Th></Th>
              </Tr>
            </Tfoot>
              </Table>
